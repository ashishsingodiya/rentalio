...
import { Home, Search, Heart, Calendar, PackageCheck, HelpCircle, User, LogOut, Menu, X } from "lucide-react";
...
const dropdownItems = [
  ...
  { label: "Move-in", path: "/move-in", icon: PackageCheck },
  { label: "Support", path: "/support", icon: HelpCircle },
];

const TenantHeader = ({ user, logout }) => {
